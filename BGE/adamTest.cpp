...
bool adamTest::Initialise()
{
	...
	shared_ptr<PhysicsController> box2;
		...
		leftFrontShin = physicsFactory->CreateBox(1, 2, 1, glm::vec3(0, 3.5, 5), glm::quat());
		rightFrontShin = physicsFactory->CreateBox(1, 2, 1, glm::vec3(3, 3.5, 5), glm::quat());

		leftBackShin =  physicsFactory->CreateBox(1, 2, 1, glm::vec3(0, 3.5, 0), glm::quat());
		rightBackShin = physicsFactory->CreateBox(1, 2, 1, glm::vec3(3, 3.5, 0), glm::quat());
